        ...
        >
          <div>
            <Avatar
              ...
              size="M"
            />
            <Text style={spacing.sapUiContentPadding}>Client Info</Text>
          </div>
          <div>
            <Avatar
              ...
              size="M"
            />
            <Text style={spacing.sapUiContentPadding}>All Projects</Text>
          </div>
          <div>
            <Avatar
            ...
            />
            <Text
              style={{ ...spacing.sapUiContentPadding, marginLeft: "0.5em" }}
            >
              Project
            </Text>
          </div>
          ...
          <div >
            <Avatar
              ...
              size="M"
            />
            <Text style={spacing.sapUiContentPadding}>Analytics</Text>
          </div>
          <div>
            <Avatar
      ...
      >
        ...
        >
          <List >
            ...
            <StandardListItem
              info="Rusting of frames"
              infoState={ValueState.Error}
            >
              FID: 20392_VID_06
            </StandardListItem>
            <StandardListItem
              info="Loose Connectors"
              infoState={ValueState.Error}
            >
              FID: 20392_VID_05
            </StandardListItem>
